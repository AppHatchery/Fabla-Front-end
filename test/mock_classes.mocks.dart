...
// in audio_diaries_flutter/test/mock_classes.dart.
...
import 'package:objectbox/src/store.dart' as _i6;
...
class _FakeBox_2<T1> extends _i1.SmartFake implements _i4.Box<T1> {
  _FakeBox_2(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
///
/// See the documentation for Mockito's code generation for more information.
class MockStore extends _i1.Mock implements _i6.Store {
  MockStore() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i4.Box<T> box<T>() => (super.noSuchMethod(
        Invocation.method(
          #box,
          [],
        ),
        returnValue: _FakeBox_2<T>(
          this,
          Invocation.method(
            #box,
            [],
  ...
  @override
  _i2.Future<R> runInTransactionAsync<R, P>(
    _i8.TxMode? mode,
    _i6.TxAsyncCallback<R, P>? callback,
    P? param,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i2.Future<R> runAsync<P, R>(
    _i6.RunAsyncCallback<P, R>? callback,
    P? param,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
...
class MockQuery<T> extends _i1.Mock implements _i3.Query<T> {
  ...
  @override
  _i2.Future<List<_i9.IdWithScore>> findIdsWithScoresAsync() =>
      (super.noSuchMethod(
        Invocation.method(
        ...
        returnValue:
            _i2.Future<List<_i9.IdWithScore>>.value(<_i9.IdWithScore>[]),
      ) as _i2.Future<List<_i9.IdWithScore>>);
  ...
  @override
  _i2.Future<List<_i9.ObjectWithScore<T>>> findWithScoresAsync() =>
      (super.noSuchMethod(
        Invocation.method(
          #findWithScoresAsync,
          [],
        ),
        returnValue: _i2.Future<List<_i9.ObjectWithScore<T>>>.value(
            <_i9.ObjectWithScore<T>>[]),
      ) as _i2.Future<List<_i9.ObjectWithScore<T>>>);

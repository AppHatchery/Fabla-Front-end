...
void main() {
  group('PromptModelComparison Tests', () {
    ...
    test('isEffectivelyEqual should handle options correctly', () {
      ...
      expect(prompt1.isEffectivelyEqual(prompt2), isTrue);
      // In production, Options.toString() returns the same value for different instances
      // since it doesn't override toString(), so different Options are considered equal
      expect(prompt1.isEffectivelyEqual(prompt3), isTrue);
    });
  });

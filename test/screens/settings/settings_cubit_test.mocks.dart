...
// in audio_diaries_flutter/test/screens/settings/settings_cubit_test.dart.
...
class MockSetupRepository extends _i1.Mock implements _i6.SetupRepository {
  MockSetupRepository() {
  ...
  @override
  _i7.Future<void> getStudies() => (super.noSuchMethod(
        Invocation.method(
          #getStudies,
          [],
        ),
  ...
  @override
  _i7.Future<bool> uploadOnBoardingQuestions() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  void deleteAllStudies() => super.noSuchMethod(
        Invocation.method(
          #deleteAllStudies,
          [],
        ),

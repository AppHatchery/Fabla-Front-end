...
class Strings {
  ...
  static String studyName = "CCSH Staff Encounters";

  static String studyDuration = "August - September 2024";

  static String researcherName = "Caroline Peacock";

  static String organisation = "Emory Healtchare";

...
/** This is an auto generated class representing the UserMetadataDev type in your schema. */
class UserMetadataDev extends amplify_core.Model {
  static const classType = const _UserMetadataDevModelType();
  final String id;
  ...
  UserMetadataDevModelIdentifier get modelIdentifier {
      return UserMetadataDevModelIdentifier(
        id: id
      );
  }
  ...
  const UserMetadataDev._internal({required this.id, start_study_date, next_study_date, recent_submit_date, day1, day2, day3, day4, day5, day6, createdAt, updatedAt}): _start_study_date = start_study_date, _next_study_date = next_study_date, _recent_submit_date = recent_submit_date, _day1 = day1, _day2 = day2, _day3 = day3, _day4 = day4, _day5 = day5, _day6 = day6, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory UserMetadataDev({String? id, String? start_study_date, String? next_study_date, String? recent_submit_date, String? day1, String? day2, String? day3, String? day4, String? day5, String? day6}) {
    return UserMetadataDev._internal(
  ...
  bool operator ==(Object other) {
    ...
    return other is UserMetadataDev &&
      id == other.id &&
  ...
  UserMetadataDev copyWith({String? start_study_date, String? next_study_date, String? recent_submit_date, String? day1, String? day2, String? day3, String? day4, String? day5, String? day6}) {
    return UserMetadataDev._internal(
      id: id,
  ...
  UserMetadataDev copyWithModelFieldValues({
  ...
  UserMetadataDev.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'start_study_date': _start_study_date, 'next_study_date': _next_study_date, 'recent_submit_date': _recent_submit_date, 'day1': _day1, 'day2': _day2, 'day3': _day3, 'day4': _day4, 'day5': _day5, 'day6': _day6, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final amplify_core.QueryModelIdentifier<UserMetadataDevModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<UserMetadataDevModelIdentifier>();
  ...
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    modelSchemaDefinition.name = "UserMetadataDev";
    modelSchemaDefinition.pluralName = "UserMetadataDevs";
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: UserMetadataDev.START_STUDY_DATE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: UserMetadataDev.NEXT_STUDY_DATE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: UserMetadataDev.RECENT_SUBMIT_DATE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: UserMetadataDev.DAY1,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: UserMetadataDev.DAY2,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: UserMetadataDev.DAY3,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: UserMetadataDev.DAY4,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: UserMetadataDev.DAY5,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: UserMetadataDev.DAY6,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
...
class _UserMetadataDevModelType extends amplify_core.ModelType<UserMetadataDev> {
  const _UserMetadataDevModelType();
  
  @override
  UserMetadataDev fromJson(Map<String, dynamic> jsonData) {
    return UserMetadataDev.fromJson(jsonData);
  }
  
  @override
  String modelName() {
    return 'UserMetadataDev';
  }
}

/**
 * This is an auto generated class representing the model identifier
 * of [UserMetadataDev] in your schema.
 */
class UserMetadataDevModelIdentifier implements amplify_core.ModelIdentifier<UserMetadataDev> {
  final String id;

  /** Create an instance of UserMetadataDevModelIdentifier using [id] the primary key. */
  const UserMetadataDevModelIdentifier({
    required this.id});
  ...
  @override
  String toString() => 'UserMetadataDevModelIdentifier(id: $id)';
  ...
  bool operator ==(Object other) {
    ...
    return other is UserMetadataDevModelIdentifier &&
      id == other.id;
  }
